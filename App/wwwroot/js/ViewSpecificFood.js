...
var keyDisplayNames = {
    ...
    'intercambioGrasa': 'Intercambio Gras',
...
btnDelete.addEventListener("click", function () {
    ...
    $.ajax({
        ...
        url: "https://localhost:7187/api/Food/Delete?id=" + id,
        method: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        ...
        success: function (data) {
            console.log(data)
            showSwalAlert("Alimento eliminado con exito", "", "/Nutri/Menu");
        },
        error: function (error) {
...
btnModify.addEventListener("click", function () {
    ...
    window.location.href = '/Nutri/UpdateFood/' + id
